...
public class AplicativoController implements Initializable {
    ...
    @FXML
    private Label ingredientesLabel1;

    @FXML
    private Label ingredientesLabel2;
    @FXML
    private Label preparoLabel;

    @FXML
    private Label preparoLabel1;

    @FXML
    private Label preparoLabel2;
    @FXML
    ...
    @FXML
    public void novaReceitaAtt(String nome, String ingredientes, String passos) {
    ...
    private void comboBoxFilter() { //Outra logica, sorry....
        String selectedTipo = tCombo.getValue();
        List<Receita> receitasFilter = receitas.stream().filter(receita -> receita.getCategoria().equals(selectedTipo)).toList();
        clearReceitasDisplay();
        if (!receitasFilter.isEmpty()) {
            Receita receita = receitasFilter.getFirst();
            nomeReceita.setText(receita.getNome());
            preparoReceita.setText(receita.getPassos());
            ingredienteReceita.setText(receita.getIngredientes());
    ...
    private void clearReceitasDisplay() {
        ...
        ingredienteReceita.setText("");
        nomeReceita1.setText("");
        preparoReceita1.setText("");
        ingredienteReceita1.setText("");
        nomeReceita2.setText("");
        preparoReceita2.setText("");
        ingredienteReceita2.setText("");
        labelIngrediente.setText("");
        labelPreparo.setText("");
        preparoLabel1.setText("");
        preparoLabel2.setText("");
        preparoLabel.setText("");
        ingredientesLabel.setText("");
        ingredientesLabel1.setText("");
        ingredientesLabel2.setText("");
